#!/bin/bash
# @TODO: create configuration for daily activites, until then, copy over manually.  After this script runs the distribution repo should have the correct folder structure and git ignore files in place for hiding solutions and solved activites.
...
VAR_WEEK='6'
VAR_WEEK_DIR="06-Week" # dir in 02-lesson-plans
VAR_CONTENT_DIR="06-ajax" # dir in 01-Class-Content
...
cp -r Images Slide-Shows $DIST_WEEK_DAY01
...
cp -r Images Slide-Shows $DIST_WEEK_DAY02
...
cp -r Images Slide-Shows $DIST_WEEK_DAY03
